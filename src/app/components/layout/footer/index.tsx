          ...
          <div className="md:col-span-8 col-span-12 grid grid-cols-12 gap-4 px-4 sm:px-0">
            <div className="w-full lg:col-span-4 col-span-12">
              ...
              <p className="mb-6 text-gray text-base">
                Pradeep Kitchen & Bakery , Ramapuram , Chennai - 600089
              </p>
            ...
            <div className="w-full lg:col-span-4 col-span-12">
              ...
              <ul>
                ...
                <li>
                  <Link href="/LFood/LFoodlist" className="mb-3 inline-block text-base text-gray hover:text-white">
                    LFood
                  </Link>
                </li>
                <li>
            ...
            <div className="w-full lg:col-span-4 col-span-12">
              ...
              <ul>
                <li onClick={() => updateFilter('keyword', 'Chicken Biryani')}>
                  <Link href="/LFood/LFoodlist" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Chicken Biryani
                  </Link>
                </li>
                <li onClick={() => updateFilter('keyword', 'Mutton Biryani')}>
                  <Link href="/LFood/LFoodlist" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Mutton Biryani
                  </Link>
                </li>
                <li onClick={() => updateFilter('keyword', 'Strawberry Donut ')}>
                  <Link href="/LFood/LFoodlist" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Strawberry Donut 
                  </Link>
                </li>
                <li onClick={() => updateFilter('keyword', 'Chicken Puff')}>
                  <Link href="/LFood/LFoodlist" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Chicken Puff
                  </Link>
                </li>
          ...
          <div className="lg:max-w-45 max-w-full text-center lg:text-left mb-4 lg:mb-0">
            <div className="flex lg:flex-nowrap flex-wrap lg:flex-row lg:gap-11 gap-4 text-base sm:text-lg md:text-xl text-black text-opacity-50">
              <p className="text-white">
                <Link href="#" className="text-gray hover:text-white">+91 86676 30563</Link>
              </p>
              <p className="text-white">
                <Link href="#" className="text-gray hover:text-white">kpradeepkumar3005@gmail.com</Link>
              </p>
            </div>
          </div>
          <div className="max-w-lg w-full">
            <div className="flex justify-center lg:justify-end">
              <p className="items-center flex mr-3 text-base sm:text-lg md:text-xl font-bold text-white">Pradeep Mama</p>
              <input
                type="text"
